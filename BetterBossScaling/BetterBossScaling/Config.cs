...
namespace BetterBossScaling
{
    internal class Config
    {
        ...
        {
            this.HpDivisor = config.Bind("Better Boss Scaling", "Teleporter Boss HP Bonus Divisor", 11.75f, "The divisor for bonus HP scaling of teleporter bosses.");
            this.DamageDivisor = config.Bind("Better Boss Scaling", "Teleporter Boss Damage Bonus Divisor", 40f, "The divisor for bonus damage scaling of teleporter bosses.");
