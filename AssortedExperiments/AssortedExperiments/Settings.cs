...
namespace AssortedExperiments
{
    public class Settings
    {
        ...
        private readonly ConfigEntry<int> preferredMaxStacksLunar;
        ...
        public Settings(ConfigFile config)
        {
            ...
            this.preferredMaxStacksLunar = config.Bind("Item Bias", "Preferred Maximum Stack Count (Lunar)", 3, "Only prefer owned lunar items when the player's stack count for that item is below this value. Set to 0 to disable.");
        ...
        public int PreferredMaxStacksLunar => this.preferredMaxStacksLunar.Value;
