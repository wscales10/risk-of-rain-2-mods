...
namespace AssortedExperiments
{
    internal class Settings
    {
        ...
        public Settings(ConfigFile config)
        {
            ...
            this.voidInteractableSpawnChanceMultiplier = config.Bind("General", "Void Interactable Spawn Chance Multiplier", 0.6f, "Multiplier modifying how common void cradles and void seeds are.");
