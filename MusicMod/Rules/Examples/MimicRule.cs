...
namespace Rules
{
	...
	{
		private static readonly Rule IdleRule = Switcher.Instance.Create(nameof(Context.SceneName), ScenePattern.Equals,
		...
		private static readonly Rule EnvironmentRule = Switcher.Instance.Create(
		...
		public static IReadOnlyRule<Context, ICommandList> MimicRule { get; } = Switcher.Instance.Create(
