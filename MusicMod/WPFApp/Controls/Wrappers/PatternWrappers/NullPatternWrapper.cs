...
namespace WPFApp.Controls.Wrappers.PatternWrappers
{
        ...
        where T : class
    {
        ...
        protected override SaveResult<ClassNullPattern<T>> tryGetValue(GetValueRequest request) => new((bool)UIElement.IsChecked ? ClassNullPattern<T>.IsNull : ClassNullPattern<T>.IsNotNull);
    }
        ...
        where T : struct
    {
        ...
        protected override SaveResult<NullableNullPattern<T>> tryGetValue(GetValueRequest request) => new((bool)UIElement.IsChecked ? NullableNullPattern<T>.IsNull : NullableNullPattern<T>.IsNotNull);
    }
}