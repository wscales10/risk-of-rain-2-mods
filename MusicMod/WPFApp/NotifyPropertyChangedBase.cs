...
namespace WPFApp
{
	public abstract class NotifyPropertyChangedBase : INotifyPropertyChanged
	{
		...
		protected void SetPropertyDependency(string propertyName, INotifyPropertyChanged source, IEnumerable<string> dependentOn)
		{
		...
		{
			SetPropertyDependency(propertyName, source, (IEnumerable<string>)dependentOn);
		}
