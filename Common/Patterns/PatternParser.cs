    ...
    public class PatternParser
    {
        ...
        protected PatternParser()
        {
            typeDefs = new Dictionary<string, ITypeDefGetter>
            {
                ...
                [nameof(Enum)] = EnumRangePattern.TypeDef,
                [nameof(Enum) + "`1"] = EnumRangePattern.GenericTypeDef.Get(this),
        ...
        public IPattern<T> Parse<T>(XElement element)
        {
            switch (element.Name.ToString())
            {
                ...
                case "Pattern":
                    ...
                    return (IPattern<T>)GetTypeDef(typeRef).Definer(Utils.HelperMethods.XmlDecode(element.Value));
                ...
                case "Maths":
                    return (IPattern<T>)typeof(MathsPattern<>).MakeGenericType(typeof(T).Denullabled()).Construct(element.Value);
